...
int main() {
    ...
    // cout<<"Enter the intermediate nodes for which you need the onput: ";
    // while(1){
    //     int node = 0;
    //     cin>>node;
    ...
    // }
    cout<< set_2(mtx) << endl;
    cout<< set_1_2(mtx) << endl;
    cout<< set_2_3(mtx) <<endl;
    cout<< set_1_3(mtx) << endl;
    cout<< dest2_MidNode3(mtx) << endl;
